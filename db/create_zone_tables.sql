-- SQL Script: Create zone_openings and zone_connections tables
-- 
...
DROP TRIGGER IF EXISTS zone_openings_updated_at ON zone_openings;
...
DROP TRIGGER IF EXISTS zone_connections_updated_at ON zone_connections;
...
-- Note: The CHECK constraint for same estimate is complex and would require a function
